...
{success === true && message && (
      ...
      <div className="space-y-1">
       ...
       <label htmlFor="shouldAttachUsersByDomain" className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">This will automatically invite all members with same e-mail domain to this organization.</p>
       </label>
       </div>
      ...
      <Button type="submit" className="w-full" disabled={isPending}>{isPending ? ( <Loader2 className="size-4 animate-spin"/> ) : ( 'Save organization' )}</Button>
